...
func (p *UserServiceClient) GetUserInfo(ctx context.Context, req *DouyinUserRequest) (r *DouyinUserRequest, err error) {
...
type UserServiceGetUserInfoResult struct {
	Success *DouyinUserRequest `thrift:"success,0,optional" frugal:"0,optional,DouyinUserRequest" json:"success,omitempty"`
}
...
var UserServiceGetUserInfoResult_Success_DEFAULT *DouyinUserRequest

func (p *UserServiceGetUserInfoResult) GetSuccess() (v *DouyinUserRequest) {
	if !p.IsSetSuccess() {
...
func (p *UserServiceGetUserInfoResult) Field0DeepEqual(src *DouyinUserRequest) bool {
