...
type DouyinGetInteractInfoResponse struct {
	BaseResp     *base.DouyinBaseResponse `thrift:"base_resp,1" frugal:"1,default,base.DouyinBaseResponse" json:"base_resp"`
	InteractInfo *base.InteractInfo       `thrift:"interact_info,2" frugal:"2,default,base.InteractInfo" json:"interact_info"`
}
...
type DouyinBatchGetInteractInfoResponse struct {
	BaseResp         *base.DouyinBaseResponse `thrift:"base_resp,1" frugal:"1,default,base.DouyinBaseResponse" json:"base_resp"`
	InteractInfoList []*base.InteractInfo     `thrift:"interact_info_list,2" frugal:"2,default,list<base.InteractInfo>" json:"interact_info_list"`
}
