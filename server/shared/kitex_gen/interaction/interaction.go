...
func (p *DouyinFavoriteListRequest) GetViewerId() (v int64) {
	return p.ViewerId
}

func (p *DouyinFavoriteListRequest) GetOwnerId() (v int64) {
	return p.OwnerId
}
func (p *DouyinFavoriteListRequest) SetViewerId(val int64) {
	p.ViewerId = val
}
func (p *DouyinFavoriteListRequest) SetOwnerId(val int64) {
	p.OwnerId = val
}
...
type DouyinFavoriteListResponse struct {
	BaseResp  *base.DouyinBaseResponse `thrift:"base_resp,1,required" frugal:"1,required,base.DouyinBaseResponse" json:"base_resp"`
	VideoList []*base.Video            `thrift:"video_list,2,required" frugal:"2,required,list<base.Video>" json:"video_list"`
}
...
func NewDouyinFavoriteCountRequest() *DouyinFavoriteCountRequest {
	return &DouyinFavoriteCountRequest{}
}

func (p *DouyinFavoriteCountRequest) InitDefault() {
	*p = DouyinFavoriteCountRequest{}
}

func (p *DouyinFavoriteCountRequest) GetVideoId() (v int64) {
	return p.VideoId
}
func (p *DouyinFavoriteCountRequest) SetVideoId(val int64) {
	p.VideoId = val
}

var fieldIDToName_DouyinFavoriteCountRequest = map[int16]string{
	1: "video_id",
}

func (p *DouyinFavoriteCountRequest) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_DouyinFavoriteCountRequest[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_DouyinFavoriteCountRequest[fieldId]))
}

func (p *DouyinFavoriteCountRequest) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.VideoId = v
...
func (p *DouyinFavoriteCountRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("douyin_favorite_count_request"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *DouyinFavoriteCountRequest) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *DouyinFavoriteCountRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("DouyinFavoriteCountRequest(%+v)", *p)
}

func (p *DouyinFavoriteCountRequest) DeepEqual(ano *DouyinFavoriteCountRequest) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *DouyinFavoriteCountRequest) Field1DeepEqual(src int64) bool {
...
func NewDouyinFavoriteCountResponse() *DouyinFavoriteCountResponse {
	return &DouyinFavoriteCountResponse{}
}

func (p *DouyinFavoriteCountResponse) InitDefault() {
	*p = DouyinFavoriteCountResponse{}
}

var DouyinFavoriteCountResponse_BaseResp_DEFAULT *base.DouyinBaseResponse

func (p *DouyinFavoriteCountResponse) GetBaseResp() (v *base.DouyinBaseResponse) {
	if !p.IsSetBaseResp() {
		return DouyinFavoriteCountResponse_BaseResp_DEFAULT
	}
	return p.BaseResp
}

func (p *DouyinFavoriteCountResponse) GetCount() (v int64) {
	return p.Count
}
func (p *DouyinFavoriteCountResponse) SetBaseResp(val *base.DouyinBaseResponse) {
	p.BaseResp = val
}
func (p *DouyinFavoriteCountResponse) SetCount(val int64) {
	p.Count = val
}

var fieldIDToName_DouyinFavoriteCountResponse = map[int16]string{
	1: "base_resp",
	2: "count",
}

func (p *DouyinFavoriteCountResponse) IsSetBaseResp() bool {
	return p.BaseResp != nil
}

func (p *DouyinFavoriteCountResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_DouyinFavoriteCountResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_DouyinFavoriteCountResponse[fieldId]))
}

func (p *DouyinFavoriteCountResponse) ReadField1(iprot thrift.TProtocol) error {
	p.BaseResp = base.NewDouyinBaseResponse()
	if err := p.BaseResp.Read(iprot); err != nil {
		return err
	}
...
func (p *DouyinFavoriteCountResponse) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.Count = v
...
func (p *DouyinFavoriteCountResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("douyin_favorite_count_response"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *DouyinFavoriteCountResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("base_resp", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.BaseResp.Write(oprot); err != nil {
...
func (p *DouyinFavoriteCountResponse) writeField2(oprot thrift.TProtocol) (err error) {
...
func (p *DouyinFavoriteCountResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("DouyinFavoriteCountResponse(%+v)", *p)
}

func (p *DouyinFavoriteCountResponse) DeepEqual(ano *DouyinFavoriteCountResponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *DouyinFavoriteCountResponse) Field1DeepEqual(src *base.DouyinBaseResponse) bool {
...
func (p *DouyinFavoriteCountResponse) Field2DeepEqual(src int64) bool {
...
var DouyinCommentCountResponse_BaseResp_DEFAULT *base.DouyinBaseResponse

func (p *DouyinCommentCountResponse) GetBaseResp() (v *base.DouyinBaseResponse) {
	if !p.IsSetBaseResp() {
		return DouyinCommentCountResponse_BaseResp_DEFAULT
	}
	return p.BaseResp
}

func (p *DouyinCommentCountResponse) GetCount() (v int64) {
	return p.Count
}
func (p *DouyinCommentCountResponse) SetBaseResp(val *base.DouyinBaseResponse) {
	p.BaseResp = val
}
func (p *DouyinCommentCountResponse) SetCount(val int64) {
	p.Count = val
}
...
func (p *DouyinCommentCountResponse) IsSetBaseResp() bool {
	return p.BaseResp != nil
}
...
func (p *DouyinCommentCountResponse) Field1DeepEqual(src *base.DouyinBaseResponse) bool {
...
func (p *DouyinCommentCountResponse) Field2DeepEqual(src int64) bool {
...
type InteractionServer interface {
	...
	FavoriteCount(ctx context.Context, req *DouyinFavoriteCountRequest) (r *DouyinFavoriteCountResponse, err error)
	...
	CommentCount(ctx context.Context, req *DouyinCommentCountRequest) (r *DouyinCommentCountResponse, err error)
...
func (p *InteractionServerClient) FavoriteCount(ctx context.Context, req *DouyinFavoriteCountRequest) (r *DouyinFavoriteCountResponse, err error) {
	var _args InteractionServerFavoriteCountArgs
	_args.Req = req
	var _result InteractionServerFavoriteCountResult
...
func (p *InteractionServerClient) CommentCount(ctx context.Context, req *DouyinCommentCountRequest) (r *DouyinCommentCountResponse, err error) {
	var _args InteractionServerCommentCountArgs
	_args.Req = req
	var _result InteractionServerCommentCountResult
...
func NewInteractionServerProcessor(handler InteractionServer) *InteractionServerProcessor {
	...
	self.AddToProcessorMap("FavoriteCount", &interactionServerProcessorFavoriteCount{handler: handler})
	...
	self.AddToProcessorMap("CommentCount", &interactionServerProcessorCommentCount{handler: handler})
...
type interactionServerProcessorFavoriteCount struct {
	handler InteractionServer
}

func (p *interactionServerProcessorFavoriteCount) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := InteractionServerFavoriteCountArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := InteractionServerFavoriteCountResult{}
	var retval *DouyinFavoriteCountResponse
...
type interactionServerProcessorCommentCount struct {
	handler InteractionServer
}

func (p *interactionServerProcessorCommentCount) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := InteractionServerCommentCountArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := InteractionServerCommentCountResult{}
...
type InteractionServerFavoriteCountArgs struct {
	Req *DouyinFavoriteCountRequest `thrift:"req,1" frugal:"1,default,DouyinFavoriteCountRequest" json:"req"`
}

func NewInteractionServerFavoriteCountArgs() *InteractionServerFavoriteCountArgs {
	return &InteractionServerFavoriteCountArgs{}
}

func (p *InteractionServerFavoriteCountArgs) InitDefault() {
	*p = InteractionServerFavoriteCountArgs{}
}

var InteractionServerFavoriteCountArgs_Req_DEFAULT *DouyinFavoriteCountRequest

func (p *InteractionServerFavoriteCountArgs) GetReq() (v *DouyinFavoriteCountRequest) {
	if !p.IsSetReq() {
		return InteractionServerFavoriteCountArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *InteractionServerFavoriteCountArgs) SetReq(val *DouyinFavoriteCountRequest) {
	p.Req = val
}

var fieldIDToName_InteractionServerFavoriteCountArgs = map[int16]string{
	1: "req",
}

func (p *InteractionServerFavoriteCountArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *InteractionServerFavoriteCountArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_InteractionServerFavoriteCountArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *InteractionServerFavoriteCountArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewDouyinFavoriteCountRequest()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *InteractionServerFavoriteCountArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *InteractionServerFavoriteCountArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *InteractionServerFavoriteCountArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("InteractionServerFavoriteCountArgs(%+v)", *p)
}

func (p *InteractionServerFavoriteCountArgs) DeepEqual(ano *InteractionServerFavoriteCountArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *InteractionServerFavoriteCountArgs) Field1DeepEqual(src *DouyinFavoriteCountRequest) bool {
...
type InteractionServerFavoriteCountResult struct {
	Success *DouyinFavoriteCountResponse `thrift:"success,0,optional" frugal:"0,optional,DouyinFavoriteCountResponse" json:"success,omitempty"`
}

func NewInteractionServerFavoriteCountResult() *InteractionServerFavoriteCountResult {
	return &InteractionServerFavoriteCountResult{}
}

func (p *InteractionServerFavoriteCountResult) InitDefault() {
	*p = InteractionServerFavoriteCountResult{}
}

var InteractionServerFavoriteCountResult_Success_DEFAULT *DouyinFavoriteCountResponse

func (p *InteractionServerFavoriteCountResult) GetSuccess() (v *DouyinFavoriteCountResponse) {
	if !p.IsSetSuccess() {
		return InteractionServerFavoriteCountResult_Success_DEFAULT
	}
	return p.Success
}
func (p *InteractionServerFavoriteCountResult) SetSuccess(x interface{}) {
	p.Success = x.(*DouyinFavoriteCountResponse)
}

var fieldIDToName_InteractionServerFavoriteCountResult = map[int16]string{
	0: "success",
}

func (p *InteractionServerFavoriteCountResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *InteractionServerFavoriteCountResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_InteractionServerFavoriteCountResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *InteractionServerFavoriteCountResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewDouyinFavoriteCountResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *InteractionServerFavoriteCountResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *InteractionServerFavoriteCountResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *InteractionServerFavoriteCountResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("InteractionServerFavoriteCountResult(%+v)", *p)
}

func (p *InteractionServerFavoriteCountResult) DeepEqual(ano *InteractionServerFavoriteCountResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *InteractionServerFavoriteCountResult) Field0DeepEqual(src *DouyinFavoriteCountResponse) bool {
...
type InteractionServerCommentCountArgs struct {
	Req *DouyinCommentCountRequest `thrift:"req,1" frugal:"1,default,DouyinCommentCountRequest" json:"req"`
}

func NewInteractionServerCommentCountArgs() *InteractionServerCommentCountArgs {
	return &InteractionServerCommentCountArgs{}
}

func (p *InteractionServerCommentCountArgs) InitDefault() {
	*p = InteractionServerCommentCountArgs{}
}

var InteractionServerCommentCountArgs_Req_DEFAULT *DouyinCommentCountRequest

func (p *InteractionServerCommentCountArgs) GetReq() (v *DouyinCommentCountRequest) {
	if !p.IsSetReq() {
		return InteractionServerCommentCountArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *InteractionServerCommentCountArgs) SetReq(val *DouyinCommentCountRequest) {
	p.Req = val
}

var fieldIDToName_InteractionServerCommentCountArgs = map[int16]string{
	1: "req",
}

func (p *InteractionServerCommentCountArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *InteractionServerCommentCountArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_InteractionServerCommentCountArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *InteractionServerCommentCountArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewDouyinCommentCountRequest()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *InteractionServerCommentCountArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *InteractionServerCommentCountArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *InteractionServerCommentCountArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("InteractionServerCommentCountArgs(%+v)", *p)
}

func (p *InteractionServerCommentCountArgs) DeepEqual(ano *InteractionServerCommentCountArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *InteractionServerCommentCountArgs) Field1DeepEqual(src *DouyinCommentCountRequest) bool {
...
type InteractionServerCommentCountResult struct {
...
func NewInteractionServerCommentCountResult() *InteractionServerCommentCountResult {
	return &InteractionServerCommentCountResult{}
}

func (p *InteractionServerCommentCountResult) InitDefault() {
	*p = InteractionServerCommentCountResult{}
}

var InteractionServerCommentCountResult_Success_DEFAULT *DouyinCommentCountResponse

func (p *InteractionServerCommentCountResult) GetSuccess() (v *DouyinCommentCountResponse) {
	if !p.IsSetSuccess() {
		return InteractionServerCommentCountResult_Success_DEFAULT
	}
	return p.Success
}
func (p *InteractionServerCommentCountResult) SetSuccess(x interface{}) {
	p.Success = x.(*DouyinCommentCountResponse)
}

var fieldIDToName_InteractionServerCommentCountResult = map[int16]string{
	0: "success",
}

func (p *InteractionServerCommentCountResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *InteractionServerCommentCountResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_InteractionServerCommentCountResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *InteractionServerCommentCountResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *InteractionServerCommentCountResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *InteractionServerCommentCountResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *InteractionServerCommentCountResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("InteractionServerCommentCountResult(%+v)", *p)
}

func (p *InteractionServerCommentCountResult) DeepEqual(ano *InteractionServerCommentCountResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *InteractionServerCommentCountResult) Field0DeepEqual(src *DouyinCommentCountResponse) bool {
