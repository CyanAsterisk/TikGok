...
struct douyin_get_relation_id_list_request {
    ...
    3: required i8  option, //FollowingList=0 FollowerList=1 FriendsList=2
}

struct douyin_get_relation_id_list_response {
    1: required base.douyin_base_response base_resp,
    2: required list<i64> user_id_list,           // List of user information
}

struct douyin_get_social_info_request{
    1: required i64 viewer_id
    2: required i64 owner_id
}

struct douyin_get_social_info_response{
    1: required base.douyin_base_response base_resp
    2: required base.SocialInfo social_info
}

struct douyin_batch_get_social_info_request{
    1: required i64 viewer_id
    2: required list<i64> owner_id_list
}

struct douyin_batch_get_social_info_response{
    1: required base.douyin_base_response base_resp
    2: required list<base.SocialInfo> social_info_list
}
